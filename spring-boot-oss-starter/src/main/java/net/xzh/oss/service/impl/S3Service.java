...
import net.xzh.oss.common.constant.CommonConstant;
 ...
 */
@Service
@ConditionalOnProperty(prefix = net.xzh.oss.common.properties.FileServerProperties.PREFIX, name = "type", havingValue = FileServerProperties.TYPE_S3)
