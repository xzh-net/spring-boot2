...
import net.xzh.mq.direct.DirectSender;
import net.xzh.mq.fanout.FanoutSender;
import net.xzh.mq.simple.SimpleSender;
import net.xzh.mq.topic.TopicSender;
import net.xzh.mq.work.WorkSender;
