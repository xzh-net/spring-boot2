...
public class TopicExchangeConfig {
    ...
    /**
     * 主题队列1 - 用于接收橙色相关和兔子相关的消息
     * 路由模式：
     * - *.orange.* : 匹配中间为orange的三段路由键
     * - *.*.rabbit : 匹配最后为rabbit的三段路由键
     */
    @Bean
