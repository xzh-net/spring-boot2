...
/**
 * 接口实现net.xzh.cxf.service.CommonService
 *
 */
@WebService(serviceName = "commonService", // 与接口中指定的name一致
		targetNamespace = "http://service.cxf.xzh.net/", // 与接口中的命名空间一致,一般是接口的包名倒
		endpointInterface = "net.xzh.cxf.service.CommonService"// 接口地址
)
@Component
