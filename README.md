...
- [Spring Boot入门](https://github.com/xzh-net/spring-boot/tree/main/spring-boot-stand)
...
- [集成GitLab API管理代码仓库](https://github.com/xzh-net/spring-boot/tree/main/spring-boot-gitlab)
- [集成Jenkins API实现流水线开发](https://github.com/xzh-net/spring-boot/tree/main/spring-boot-jenkins)
