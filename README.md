...
- [整合CXF发布WebService以及调用的方法](https://github.com/xzh-net/spring-boot2/tree/main/spring-boot-webservice)
...
- [YAML格式校验](https://github.com/xzh-net/spring-boot2/tree/main/spring-boot-yaml)
---
